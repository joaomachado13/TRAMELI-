...
- Grade A4 ajustável para impressão de teste; **não calibrada** para a folha serrilhada real.

Pix, confirmação de pagamento, prazo de corte, exceções de entrega e regras contratuais do repasse continuam pendentes. A tela financeira agora separa venda, entrega e custo conhecido da padaria; não declare custo incompleto como repasse definitivo. Não publique como versão oficial antes do checklist do piloto.
